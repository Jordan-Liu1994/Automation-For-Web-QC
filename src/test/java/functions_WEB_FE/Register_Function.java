...
//	= = = = = = = = = = = = = = = = = = = = 
	...
	public void selectRegisterOption() throws FailedLoginException {
		...
		wait.until(ExpectedConditions.visibilityOf(selectRegisterOption));
...
//	= = = = = = = = = = = = = = = = = = = = 
	...
	public void verifyRegisterUserID(String userID) throws FailedLoginException, InterruptedException {
		WebDriverWait wait = new WebDriverWait(baseDriver.getDriver(),10);
